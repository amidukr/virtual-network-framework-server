...
public class ServiceConfigurationFactory {
    ...
    public void addServiceHandlersConfiguration(ServiceHandlersConfiguration serviceHandlersConfiguration) {
        Collection<InvokeHandler> invokeHandlers = CollectionUtils.emptyIfNull(serviceHandlersConfiguration.getInvokeHandlers());
        Collection<ConnectionLostHandler> connectionLostHandlers = CollectionUtils.emptyIfNull(serviceHandlersConfiguration.getConnectionLostHandlers());
