...
import org.amidukr.software.vnf.server.mocks.ConnectionLostCaptor;
import org.amidukr.software.vnf.server.mocks.EchoHandler;
...
public class ServiceHandlersConfigurationFactoryTest {
    ...
    public void testInvokeReturnTypeInitializationException() {
        ...
        try{
            ...
            Assert.assertEquals("Method org.amidukr.software.vnf.server.core.servicefactory.ServiceHandlersConfigurationFactoryTest$1::invokeCommand should return String or InvocationResult", e.getMessage());
            throw e;
        }
    }
    ...
    @Test(expected = ServiceConfigurationException.class)
        ...
        try{
            ...
            Assert.assertEquals("Method org.amidukr.software.vnf.server.core.servicefactory.ServiceHandlersConfigurationFactoryTest$2::invokeCommand should have only one CommandEvent argument", e.getMessage());
            throw e;
        }
    ...
    public void testConnectionLostArgumentInitializationException() {
        ...
        try{
            ...
            Assert.assertEquals("Method org.amidukr.software.vnf.server.core.servicefactory.ServiceHandlersConfigurationFactoryTest$3::onConnectionLost should have only one ConnectionLostEvent argument", e.getMessage());
            throw e;
        }
    }
